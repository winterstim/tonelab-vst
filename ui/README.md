...
- Supports optional Assistant-generated chain creation.
...
- `VITE_TONELAB_DEFAULT_WEB_BASE_URL` (default fallback: `https://tonelab.dev`)
...
- `src/services/`: Assistant and update API clients.
